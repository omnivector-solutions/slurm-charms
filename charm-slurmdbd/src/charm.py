...
class SlurmdbdCharm(CharmBase):
    ...
    def _write_config_and_restart_slurmdbd(self, event):
        """Check and write config and restart slurmdbd."""
        ...
        self.slurm_ops_manager.render_config_and_restart(slurmdbd_config)
        self.slurmdbd.set_slurmdbd_available_on_unit_relation_data()
